...
const translationProgressController = require("modules/post/controllers/translationProgressController");
...
// Translation progress routes
router.get("/translation-progress/:sessionId", translationProgressController.getProgress);
router.get("/translation-progress", translationProgressController.getAllSessions);
router.delete("/translation-progress/:sessionId", translationProgressController.removeSession);
router.post("/translation-progress/cleanup", translationProgressController.cleanupSessions);
